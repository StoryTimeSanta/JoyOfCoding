...
def mangle(input_string):
    # Convert the string to all upper case letters
    uppercase_string = input_string.upper()

    # Remove the third character
    without_third_char = uppercase_string[:2] + uppercase_string[3:]

    # Remove the third to last character
    without_third_to_last_char = without_third_char[:-3] + without_third_char[-2:]
